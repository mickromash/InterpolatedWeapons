...
* Типы КВаров:
   * server - эти настройки влияют на всех игроков
   * user - персонализированные настройки для каждого игрока, но их влияние так же заметно для других игроков
   * nosave - эти настройки полностью персонализированы для каждого игрока, и никак не влияют на игру других
