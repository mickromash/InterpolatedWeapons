...
* [Список настроек мода (КВаров)](#Настройки-мода-Квары)
   ...
   * [Звук](#Настройки----Настроить-интерполированное-оружие----Настройки-звуков)
...
* Из-за того, что почти все спрайты сделаны в DOOM формате, мод совместим с модами изменяющими игровую палитру.  
...
отключение задержки перед выстрелом (без изменения темпа стрельбы), ускорение стрельбы пистолета, комбинирование оружия и отдача при ударе стены с берсерком.
...
* Кастомизация покачивания оружия: есть выбор разных стилей покачивания, покачивание оружия вперёд-назад, а также логика покачивания при стрельбе из DOS DOOM. Кроме этого можно включить инерцию движения рук игрока от движений камеры, как в Half Life 2 или SW Battlefront (2015).
...
* Система пресетов: в моде есть 2 предустановленных пресета, классический, делающий игру максимально приближённой к классическому дум, и максимальный, включающий как можно больше опций мода.
Также вы можете откатить настройки мода до заводских, что тоже можно считать пресетом. Помимо этого, есть возможность сохранить ваши собственные настройки в одну из трёх ячеек для собственного пресета.
...
| Покачивание оружия при стрельбе | [nosave] MRIntW_ChangeFiringBob | 1 | Суть та же что и у схожей настройки из меню интерфейса UZDoom (которая в моде всегда должна быть настроенна на 1) |
...
| Анимированные пункты в меню | [nosave] MRIntW_SmoothUiOptions | Да | Добавляет характерные анимации для подпунктов в меню настроек мода |
