...
* [Фичи мода](#Фичи-мода)
* [Список настроек мода (КВаров)](#Настройки-мода-Квары)
   * [Основные](#Настройки----Настроить-интерполированное-оружие)
   * [Основные настройки анимаций](#Настройки----Настроить-интерполированное-оружие----Настройки-анимаций)
   * [Общие настройки оружия](#Настройки----Настроить-интерполированное-оружие----Настройки-анимаций----Общие-настройки-оружия)
   * [Настройки каждого оружия](#Настройки----Настроить-интерполированное-оружие----Настройки-анимаций----Настроить-каждое-оружие)
   * [Частицы](#Настройки----Настроить-интерполированное-оружие----Настройки-частиц)
* [Авторы](#Кредитссс)
* [Для моддеров](#Для-моддеров)
* [Скачать мод](#ColorFF0000Дай-уже-скачать-мод-долбаный-задрот)
***
...
| Быстрая смена оружия | [server] MRIntW_QuickSwitch | Нет | Возможность сменить оружия во время анимаций перезарядки и им подобным (работает с дробовиком, двустволкой и плазмаганом) |
...
### Настройки --> Настройки анимаций --> Общие настройки оружия
| Название | [тип квара] CVar | По умолчанию | Что делает |
| --- | --- | --- | --- |
